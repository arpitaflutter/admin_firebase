...
class GooglesihninScreen extends StatefulWidget {
  const GooglesihninScreen({Key? key}) : super(key: key);

  @override
  State<GooglesihninScreen> createState() => _GooglesihninScreenState();
}

class _GooglesihninScreenState extends State<GooglesihninScreen> {
